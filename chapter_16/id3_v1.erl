-module(id3_v1).
% importing only the functions we need from "lists" module
-import(lists, [filter/2, map/2, reverse/1]).
-export([test/0, dir/1, read_id3_tag/1]).

% test() -> dir("home/joe/music_keep").
% testing my own directory
test() -> dir("/Users/mau5atron/Desktop/erlang/chapter_16/music").

% Parsing out the mp3 files in the specified directory
dir(Dir) ->
...
% Look back at page 251 to continue notes about this programs